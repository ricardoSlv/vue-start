  ...
  <v-card>
    ...
    >
      <v-list nav dense dark>
        ...
        <!-- List group se for uma secção da barra de
        navegação lateral que se divida em subsecções-->
        <v-list-group
          class="white--text"
        ...
        >
          <template v-slot:activator>
            <v-list-item-title class="white--text"
              >Nome Secção</v-list-item-title
            >
          </template>
          <v-list-item link to="Link Subsecção 1">
            <v-list-item-title class="white--text"
              >Nome Subsecção 1</v-list-item-title
            >
          </v-list-item>
          <v-list-item link to="Link Subsecção 2">
            <v-list-item-title class="white--text"
              >Nome Subsecção 2</v-list-item-title
            >
          </v-list-item>
          ...
        </v-list-group>
